...
- [Functions](#functions)
  - [1. Declaration](#1-declaration)
    ...
    - [1.3. Arrow Function](#13-arrow-function)
  - [2. Parameter \& Arguments](#2-parameter--arguments)
  - [3. Higher-Order Functions](#3-higher-order-functions)
  - [4. Best Practices for Writing Functions](#4-best-practices-for-writing-functions)
    - [4.1. Use Descriptive Names](#41-use-descriptive-names)
    - [4.2. Keep Functions Small](#42-keep-functions-small)
    - [4.3. Limit The Number of Parameter](#43-limit-the-number-of-parameter)
    - [4.4. Use Default Parameters](#44-use-default-parameters)
    - [4.5. Use Arrow Functions for Short Functions](#45-use-arrow-functions-for-short-functions)
    - [4.6. Return Early](#46-return-early)
